...
#line 1109 "parser/parser.tab.c"
    break;

  case 7: /* linha: error NEWLINE  */
#line 50 "parser/parser.y"
                          { yyerrok; }
#line 1115 "parser/parser.tab.c"
    break;

  case 8: /* atribuicao: ID IGUAL expressao  */
#line 54 "parser/parser.y"
                       {
        (yyval.no) = create_assign_node(create_id_node((yyvsp[-2].str)), (yyvsp[0].no));
    }
#line 1123 "parser/parser.tab.c"
    break;

  case 9: /* expressao: NUM  */
#line 60 "parser/parser.y"
                        { (yyval.no) = create_num_node((yyvsp[0].valor)); }
#line 1129 "parser/parser.tab.c"
    break;

  case 10: /* expressao: ID  */
#line 61 "parser/parser.y"
                        { (yyval.no) = create_id_node((yyvsp[0].str)); }
#line 1135 "parser/parser.tab.c"
    break;

  case 11: /* expressao: expressao PLUS expressao  */
#line 62 "parser/parser.y"
                                 { (yyval.no) = create_op_node('+', (yyvsp[-2].no), (yyvsp[0].no)); }
